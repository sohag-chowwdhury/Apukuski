    ...
    <b-row class="sign-up row justify-content-center">
      <b-col cols="12" sm="12" md="8" lg="6" xl="6">
        ...
        <b-row class="row justify-content-center">
          ...
          <b-col v-if="msg === true" cols="12" md="12" lg="12" xl="12">
            <b-card no-body>
              <p class="color:#000000 !important;">
                Password successfully message send
              </p>
            </b-card>
          </b-col>
        </b-row>
        <b-card class="card-sign-up">
          <b-form-input
            class="sign-up-input"
            type="email"
            v-model="email"
          ...
          <b-button
            ...
            variant="success"
            class="sign-up-btn"
            >Send Link To email</b-button
          >
          <p style="color: green" v-if="success">{{ success }}</p>
          <p style="color: red" v-if="error">{{ error }}</p>
          <p style="margin-top: 20px">
            Already have an account?<b-button variant="light" size="sm" to="/"
