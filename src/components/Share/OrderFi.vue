        ...
        <div class="d-block text-center">
          ...
          <b-row class="row justify-content-center">
            ...
            <b-col
              ...
              xl="10"
            >
              <h4>Tilauksesi tehty onnistuneesti.</h4>
              <h4>
                Tilaustunnus: #5x34221 ,
                <span> Hinta: {{ price.toFixed(2) }}</span>
                <img
                  class="img-euro"
        ...
        <b-col cols="12" sm="8" md="8" lg="8" xl="8">
          <b-row class="my-0">
            <b-col cols="9" sm="9" md="11" lg="11" xl="11">
              <p class="mx-2 my-1">
                Nouto-osoitteen yhteyshenkilö on eri kuin tilaaja.
              </p>
            </b-col>
          ...
          <b-row class="my-0">
            <b-col cols="9" sm="9" md="11" lg="11" xl="11">
              <p class="mx-2 my-1">
                Toimitusosoitteen yhteyshenkilö on eri kuin tilaaja.
              </p>
            </b-col>
          ...
          <b-row class="my-0">
            <b-col cols="9" sm="9" md="11" lg="11" xl="11">
              <p class="mx-2 my-1">
                Maksa kortilla tai käteisellä kuljetuksen yhteydessä.
              </p>
            </b-col>
            <b-col cols="2" sm="2" md="1" lg="1" xl="1">
              <b-button
          ...
          <b-row class="my-0">
            <b-col cols="9" sm="9" md="11" lg="11" xl="11">
              <p class="mx-2 my-1">Maksa laskulla (vain yritysasiakkaille).</p>
            </b-col>
            <b-col cols="2" sm="2" md="1" lg="1" xl="1">
              <b-button
            ...
            <b-col cols="12" sm="12" lg="12" xl="12" md="12">
              <b-form-textarea
                class="input-field"
                v-model="message"
                placeholder="Viesti työntekijälle"
              ></b-form-textarea>
            </b-col>
          </b-row>
