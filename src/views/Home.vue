      ...
      <div class="overlay">
        ...
        <b-row class="row justify-content-center">
          <b-col class="main-section" cols="12" sm="12" md="6" xl="6" lg="6">
            <h3 style="">
              Kuljetukset, muutot, tavaranoudot ja kantoapu silloin kun niitä
              tarvitset!
            </h3>
    ...
    <v-container v-if="checkSection > 0">
      ...
      <b-row class="row justify-content-center">
        <b-col
          ...
          xl="8"
        >
          <h4 style="text-align: center">Kuinka voimme auttaa?</h4>
          ...
          >
            <b-row class="mx-1" @click="manuFunc(item.title)">
              ...
              <b-col class="manu-text" cols="7" sm="7" lg="7" xl="7" md="7">
                <h5 class="margin:0px;">{{ item.title_in_finnish }}</h5>
                <p v-if="item.id">{{ item.description_in_finnish }}</p>
              </b-col>
              <b-col
      ...
      <b-row class="row justify-content-center">
        ...
        <b-col
          ...
          xl="8"
        >
          <h4 style="text-align: center">Kuljetettavat tavarat</h4>
          ...
          <b-row class="row justify-content-center">
            ...
            >
              ...
              />
              <h5 style="opacity: 0.7 !important">--tai--</h5>
              <h5 style="opacity: 0.7 !important">Valitse yleisimmistä</h5>
            </b-col>
          </b-row>
            ...
            <b-row>
              ...
              >
                <h5 :class="item.description == '.' ? 'vartical-text' : ''">
                  {{ item.name_in_finnish }}
                </h5>
                <p v-if="item.description != '.'">
                  {{ item.description_in_finnish }}
                </p>
              </b-col>
              <b-col
                style="text-align: end"
        ...
        <b-col v-if="checkSection == 3" cols="11" sm="11" md="8" lg="8" xl="8">
          <b-card style="width: 100%; background: #dd0303">
              ...
              <b-col cols="11" sm="11" md="10" lg="10" xl="10">
                <form @submit.prevent="funcLocation">
                  <input
                    ...
                    style="width: 100%; height: 40px; border-color: red"
                    type="text"
                    placeholder="Ensimmäinen pysähdys"
                    ref="drop1"
                  />
                </form>
              </b-col>
            ...
            <b-row>
              ...
              <b-col v-if="locPlace < 5" cols="6" sm="5" lg="5" xl="5" md="5">
                <b-button
                  :disabled="
                    locations[0].lat == 0 ||
                  ...
                  size="sm"
                  @click="addLocFunc"
                  style="background: #dd0303 !important; width: 220px"
                >
                  <img
                    style="width: 25px"
                    src="https://img.icons8.com/ios-glyphs/30/ffffff/add--v1.png"
                  />
                  Lisää pysähdys</b-button
                >
              </b-col>
              <b-col v-if="locPlace > 2" cols="1" sm="1" lg="1" xl="1" md="1">
              </b-col>
              <b-col v-if="locPlace > 2" cols="5" sm="5" lg="5" xl="5" md="5">
                <b-button
                  variant="danger"
                  size=""
                  @click="minLocFunc"
      ...
      >
        <b-col class="elevator" cols="12" sm="12" md="8" lg="8" xl="8">
          <h4 style="text-align: center">Osoitteiden lisätiedot</h4>
        </b-col>
        <b-col
        ...
        >
          <h5 v-if="locations[index].label != undefined">
            ...
            />
            <span v-if="index == 0">Nouto</span>
            <span v-if="index == locations.length - 1">Toimitus</span>
            ...
            <b-row>
              <b-col cols="9" sm="9" md="10" lg="10" xl="10">
                <p v-if="index == 0" class="mx-2">
                  Tavara noudetaan sisältä, maantasalta
                </p>
                <p v-if="index == locations.length - 1" class="mx-2">
                  Tavara noudetaan pihasta.
                </p>
                <p
                  v-if="index != 0 && index != locations.length - 1"
                  class="mx-2"
                >
                  Tavara noudetaan/noudetaan sisältä, maantasalta.
                </p>
              </b-col>
          ...
          >
            <b-row>
              <b-col cols="9" sm="9" md="10" lg="10" xl="10">
                <p class="mx-2">Tavara noudetaan pihasta</p>
              </b-col>
              <b-col cols="3" sm="3" md="2" lg="2" xl="2">
                <b-button
          ...
          >
            <b-row>
              <b-col cols="9" sm="9" md="10" lg="10" xl="10">
                <p class="mx-2">Kantaja/ -t voivat käyttää hissiä</p>
              </b-col>
              <b-col cols="3" sm="3" md="2" lg="2" xl="2">
                <b-button
            ...
            <b-row class="row justify-content-center">
              <b-col cols="7" sm="7" md="7" lg="8" xl="9">
                <p style="text-align: start !important" class="mx-2">
                  Kantajan/ -jien täytyy käyttää rappusia
                </p>
              </b-col>
            ...
            <b-row v-if="pickItems.length == 0 && index == 0">
              <b-col>
                <b-form-textarea
                  id="textarea-small"
                  size="md"
                  placeholder="Lisätietoja kuljetettavasta tavarasta tai nouto-osoitteesta"
                ></b-form-textarea>
              </b-col>
            </b-row>
            <b-row
          ...
          <b-card v-if="index == 0 && locations.length > 2" style="width: 100%">
            <b-row cols="row justify-content-start">
              <p class="loc-p">
                Saatavilla olevat tuotteet ja määrä noutoa varten
              </p>
              <b-col
                class="my-1"
              ...
              <b-col
                ...
                xl="12"
              >
                <p class="loc-p">Valitut tuotteet ja määrä noudettavaksi</p>
                <b-row>
                  <b-col
                    class="loc-card"
                    style="height: 70px"
                ...
                <b-row>
                  <b-col>
                    <b-form-textarea
                      id="textarea-small"
                      size="sm"
                      placeholder="Lisätietoja kuljetettavasta tavarasta tai toimitusosoitteesta"
                    ></b-form-textarea>
                  </b-col>
                </b-row>
              </b-col>
          ...
          >
            <b-row cols="row justify-content-start">
              ...
              <!-- drop -->
              <p class="loc-p my-2">
                Saatavilla olevat tuotteet ja määrä Dropille
              </p>
              <b-col
                class="my-1"
              ...
              <b-col
                ...
                xl="12"
              >
                <p class="loc-p">Valitut tuotteet ja määrä Dropille</p>
                <b-row>
                  <b-col
                    class="loc-card"
                    style="height: 70px"
                ...
                <b-row>
                  <b-col>
                    <b-form-textarea
                      id="textarea-small"
                      size="sm"
                      placeholder="Tuotteen tiedot ensimmäisestä pysäytyksestä"
                    ></b-form-textarea>
                  </b-col>
                </b-row>
              </b-col>
          ...
          >
            <b-row cols="row justify-content-start">
              <p class="loc-p">
                Saatavilla olevat tuotteet ja määrä noudettavaksi
              </p>
              <b-col
                class="my-1"
                v-for="(item, i) in summeryValue"
                ...
                <b-row>
                  <b-col>
                    <b-form-textarea
                      id="textarea-small"
                      size="sm"
                      placeholder="Tietoja tuotteesta kakkosesta"
                    ></b-form-textarea>
                  </b-col>
                </b-row>
              </b-col>
                ...
                <b-row>
                  <b-col>
                    <b-form-textarea
                      id="textarea-small"
                      size="sm"
                      placeholder="Tuotteen tiedot pysäytyksestä kolme"
                    ></b-form-textarea>
                  </b-col>
                </b-row>
              </b-col>
                ...
                <b-row>
                  <b-col>
                    <b-form-textarea
                      id="textarea-small"
                      size="sm"
                      placeholder="Tuotteen tiedot palautuspaikalta"
                    ></b-form-textarea>
                  </b-col>
                </b-row>
              </b-col>
          ...
          ><b-card no-body style="width: 100%">
            ...
            >
              <p
                ...
                v-if="summeryCheck !== 0"
              >
                *Jäljellä oleva tuote noudettavaksi: {{ summeryCheck }}
              </p>
              <p
                style="font-size: 12px; color: red; font-weight: 600"
                v-if="summeryCheck == 0 && dropCheck !== 0"
              >
                *Jäljellä oleva Drop Up -tuote: {{ dropCheck }}
              </p>
            </b-col>
            <b-row class="my-1">
              <b-col>
      ...
      <b-row v-if="checkSection == 5" class="row justify-content-center">
        <b-col class="elevator" cols="12" sm="12" md="8" lg="8" xl="8">
          <h4
            ...
            "
          >
            Kuinka monta kantajaa tarvitset?
          </h4>
          <b-card no-body style="width: 100%">
            <b-row>
              ...
              <b-col class="manu-text" cols="7" sm="7" md="8" lg="8" xl="8">
                <h5>{{ helper[0].title_in_finnish }}</h5>
                <p>{{ helper[0].description_in_finnish }}</p>
              </b-col>
              <b-col cols="3" sm="3" md="2" lg="2" xl="2">
                <b-button
                  class="helper-btn"
          ...
          <b-card no-body class="mt-1" style="width: 100%">
            <b-row>
              ...
              <b-col class="manu-text" cols="7" sm="7" md="8" lg="8" xl="8">
                <h5>{{ helper[1].title_in_finnish }}</h5>
                <p>{{ helper[1].description_in_finnish }}</p>
              </b-col>
              <b-col cols="3" sm="3" md="2" lg="2" xl="2">
                <b-button
                  class="helper-btn"
      ...
      >
        ...
        <b-col class="price-section" cols="11" sm="11" md="7" lg="7" xl="7">
          ...
          <h3 v-if="pirceCarId != null">
            <span v-if="hourlyRate == 79">Kaksi kantajaa ja </span>
            <span v-if="hourlyRate != 79">Kantajan ja </span>
            <span v-if="pirceCarId.vehicle_id == '1'"> 19m3</span>
            <span v-if="pirceCarId.vehicle_id == '2'"> 6m3</span> -kokoisen
            pakettiauton
          </h3>
          <p>
            <img
            ...
            />Tarvittavat välineet tavaran turvalliseen kuljettamiseen ja
            kantamiseen.
          </p>
          <p>
            <img
            ...
            />Tavarat on vakuutettu kuljetuksen ajaksi.
          </p>
          <p>
            <img
              class="img"
              src="https://img.icons8.com/ios/50/000000/price-tag-euro.png"
            />Etukäteishinnoittelu..
          </p>
        </b-col>
            ...
            <b-row class="row justify-content-center align-items-center">
              ...
              <b-col class="log-tag" cols="10">
                <h4 style="text-align: center">
                  Kymmeniä kuljetuksia tilattu viime viikolla.
                </h4>
              </b-col>
            </b-row>
          </b-card>
  ...
  methods: {
    ...
    buttonAdd(e, j) {
      ...
      let data = {
        ...
        description_in_finnish: e.description_in_finnish,
      };
